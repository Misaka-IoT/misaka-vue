...
export default {
  ...
  methods: {
    ...
    ClickChat () {
      ...
      document.getElementsByClassName("sc-chat-window")[0].setAttribute("style","bottom:200px;z-index:20");
    ...
    SendGPTs(res:any)
    {
      this.messageList = [ ...this.messageList,{ type: 'text', author: `Misaka`, data: { text: res } } ];
    }
  },
  created() {
